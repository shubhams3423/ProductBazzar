    ...
    <>
      <Layout>
        <div className=" bg-gray-100 pt-5 ">
          ...
          <div className="mx-auto max-w-5xl justify-center  flex max-md:flex-col max-md:px-5 md:space-x-6 xl:px-0 relative md:order-1">
            <div className=" max-sm:h-[56vh] max-sm:overflow-y-scroll md:w-[70%] max-md:order-1 ">
            ...
            <div
              className={`  rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3 h-fit mb-4 ${
            ...
            >
              ...
              <div className="flex justify-between mb-3">
                ...
                <div className>
                  <p className="mb-1 text-lg font-bold">₹135.00</p>
                </div>
              </div>
              <button
